      ...
      {isMenuOpen && (
        <div className="md:hidden">
          <div className="flex flex-col items-center bg-teal-800 py-4">
            <Link to="/" className="block px-4 py-2 text-sm text-white" onClick={handleLinkClick}>Home</Link>
            <Link to="/about" className="block px-4 py-2 text-sm text-white" onClick={handleLinkClick}>About Us</Link>
            <Link to="/services" className="block px-4 py-2 text-sm text-white" onClick={handleLinkClick}>Services</Link>
            <Link to="/contact" className="block px-4 py-2 text-sm text-white" onClick={handleLinkClick}>Contact</Link>
            <Link to="/login" className="block px-4 py-2 text-sm bg-gray-900 text-white rounded-md mt-4" onClick={handleLinkClick}>Sign In Student</Link>
            <Link to="/login" className="block px-4 py-2 text-sm bg-gray-900 text-white rounded-md mt-2" onClick={handleLinkClick}>Sign In Teacher</Link>
          </div>
        </div>
      )}
    </nav>
